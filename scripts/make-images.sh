...
pnmcat -tb amiga/colormap/* | pnmcolormap all -sort | pnmtoplainpnm > amiga/finalcolors.ppm
...
cat amiga/finalcolors.ppm | amiga/vgapal.py > planlusv/VGA.PAL
